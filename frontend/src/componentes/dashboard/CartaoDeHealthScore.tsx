...
interface PropsDoCartaoDeHealthScore {
  score: number | null;
  repo: string;
}
...
export function CartaoDeHealthScore({ score, repo }: PropsDoCartaoDeHealthScore) {
  return (
    <div className="flex flex-col items-center justify-center gap-2 py-4">
      <p className="text-sm text-gray-400">Health Score de {repo}</p>
